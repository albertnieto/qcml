...
class AnsatzEmbeddingKernel(BaseEstimator, ClassifierMixin):
    def __init__(
        self,
        classifier=None,
        repeats=2,
    ...
    def construct_circuit(self):
        ...
        dev = qml.device(self.dev_type, wires=num_wires, **self.qnode_kwargs)
        ...
        if self.jit:
            kernel_circuit = jax.jit(kernel_circuit)
